...
const Counter = () => {
    ...
    return (
        <>
            <div className='flex items-center justify-center gap-[166px] max-2xl:gap-[140px] max-xl:gap-[100px] max-lg:gap-12 max-md:gap-8 max-sm:gap-3 max-lg:flex-col mt-[78px] max-xl:mt-20px max-lg:mt-10 max-md:mt-5'>
             <div>
